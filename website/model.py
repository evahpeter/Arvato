# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 01:03:09 2020
...
c = ClassifierCSV('UAUC_wk4-9_2020.csv', featureset_size=3000)
c.train_naive_bayes_classifier()
#c.classifier.show_most_informative_features(15)
c.save_model ('uauc_model.pkl')
c.load_model('uauc_model.pkl', 'vocab-uauc_model.pkl')
print(ClassifierCSV.classify_new_sentence(c,'3 dead bulbs at instrument air (unit 32)  IMMEDIATE ACTION TAKEN: Engaged electrical team and dead bulbs were replaced.'))